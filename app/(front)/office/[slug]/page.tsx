...
export default function OfficeDetailPage({ params }: Props) {
    ...
    return (
        <>
            ...
            <OfficeHeader office={{ image: office.image, images: office.images }} />
            <section
                id="Details"
            ...
            >
                <div className="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    <p className="w-fit rounded-full p-[6px_16px] bg-[#0D903A] font-bold text-sm leading-[21px] text-[#F7F7FD]">
                        {office.isFullyBooked ? "Fully Booked" : "Available"}
                    </p>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col gap-[6px]">
                            ...
                            <p className="font-semibold text-right">{office.rating}/5 (19000)</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-x-5 gap-y-[30px]">
                        {office.features.map((feature, index) => (
                            <OfficeFeature key={index} office={feature} />
                        ))}
                    </div>
